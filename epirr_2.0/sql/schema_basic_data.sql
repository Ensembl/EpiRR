...
CREATE TABLE public.epigenome_version (
    ...
    ihec_version_id integer NOT NULL,
    description text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Data for Name: archive; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.archive (archive_id, name, full_name, url, base_url) FROM stdin;
1	GEO	Gene Expression Omnibus	https://www.ncbi.nlm.nih.gov/geo/	\N
2	EGA	European Genome-phenome archive	https://www.ebi.ac.uk/ega/	\N
3	DDBJ	DNA Data Bank of Japan	https://www.ddbj.nig.ac.jp/index-e.html	\N
4	SRA	NCBI Sequence Read Archive	https://www.ncbi.nlm.nih.gov/sra	\N
5	ENA	European Nucelotide Archive	https://www.ebi.ac.uk/ena/	\N
6	JGA	Japanese Genotype-phenotype Archive	https://www.ddbj.nig.ac.jp/index-e.html	\N
7	ENCODE	Encyclopedia of DNA Elements	https://www.encodeproject.org/	\N
\.


--
-- Data for Name: epigenome; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.epigenome (epigenome_id, accession, description, project_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: epigenome_version; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.epigenome_version (epigenome_version_id, epigenome_id, full_accession, version, is_current, status_id, ihec_version_id, description, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: epigenome_version_experiment; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.epigenome_version_experiment (epigenome_experiment_id, epigenome_version_id, experiment_id) FROM stdin;
\.


--
-- Data for Name: experiment; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.experiment (experiment_id, accession, secondary_accession, archive_id, library_strategy_id, experiment_type_id, ihec_version_id, uri, xml, md5sum, validator_report, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: experiment_metadata; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.experiment_metadata (experiment_metadata_id, experiment_id, key, value) FROM stdin;
\.


--
-- Data for Name: experiment_sample; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.experiment_sample (experiment_sample_id, experiment_id, sample_id) FROM stdin;
\.


--
-- Data for Name: experiment_type; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.experiment_type (experiment_type_id, name) FROM stdin;
\.


--
-- Data for Name: ihec_version; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.ihec_version (ihec_version_id, version, url) FROM stdin;
1	0.000	https://github.com/IHEC/ihec-ecosystems#metadata-specification
2	1.000	https://github.com/IHEC/ihec-ecosystems/blob/master/docs/metadata/1.0/Ihec_metadata_specification.md
3	2.000	https://github.com/IHEC/ihec-ecosystems/blob/master/docs/metadata/2.0/Ihec_metadata_specification.md
\.


--
-- Data for Name: library_strategy; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.library_strategy (library_strategy_id, name) FROM stdin;
...
--
-- Data for Name: project; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.project (project_id, name, url) FROM stdin;
1	BLUEPRINT	https://www.blueprint-epigenome.eu/
2	NIH Roadmap Epigenomics	http://www.roadmapepigenomics.org/
3	DEEP	http://www.deutsches-epigenom-programm.de/
4	AMED-CREST	http://crest-ihec.jp/english/index.html
5	ENCODE	https://www.encodeproject.org/
6	Korea Epigenome Project (KNIH)	http://nih.go.kr/contents.es?mid=a50303010300
7	CEEHRC	http://www.epigenomes.ca/
8	GIS	https://www.a-star.edu.sg/gis/our-science/epigenetic-and-epitranscriptomic-regulation
9	EpiHK	https://epihk.org/
\.


--
-- Data for Name: sample; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.sample (sample_id, accession, ihec_version_id, xml, uri, md5sum, validator_report, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: sample_metadata; Type: TABLE DATA; Schema: public; Owner: juettema
--

COPY public.sample_metadata (sample_metadata_id, sample_id, key, value) FROM stdin;
\.


--
-- Data for Name: status; Type: TABLE DATA; Schema: public; Owner: juettema
--
...
--
-- Name: archive_archive_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.archive_archive_id_seq', 7, true);


--
-- Name: epigenome_epigenome_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.epigenome_epigenome_id_seq', 1, false);


--
-- Name: epigenome_experiment_epigenome_experiment_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.epigenome_experiment_epigenome_experiment_id_seq', 1, false);


--
-- Name: experiment_experiment_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.experiment_experiment_id_seq', 1, false);


--
-- Name: experiment_metadata_experiment_metadata_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.experiment_metadata_experiment_metadata_id_seq', 1, false);


--
-- Name: experiment_sample_experiment_sample_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.experiment_sample_experiment_sample_id_seq', 1, false);


--
-- Name: experiment_type_experiment_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.experiment_type_experiment_type_id_seq', 1, false);


--
-- Name: experiment_version_experiment_version_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.experiment_version_experiment_version_id_seq', 1, false);


--
-- Name: ihec_version_ihec_version_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.ihec_version_ihec_version_id_seq', 3, true);


--
-- Name: library_strategy_library_strategy_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.library_strategy_library_strategy_id_seq', 9, true);


--
-- Name: project_project_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.project_project_id_seq', 9, true);


--
-- Name: sample_metadata_sample_metadata_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--

SELECT pg_catalog.setval('public.sample_metadata_sample_metadata_id_seq', 1, false);


--
-- Name: sample_sample_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--
...
--
-- Name: status_status_id_seq; Type: SEQUENCE SET; Schema: public; Owner: juettema
--
