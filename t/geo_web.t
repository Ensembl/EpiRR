...
my $ge = EpiRR::Service::GeoEutils->new();
...
SKIP: {
    ...
    is( $actual_experiment_type, 'Histone H3K4me1', 'Correct experiment type' );
    is_deeply( $actual_sample, $expected_sample, 'Correct sample metadata' );
}
done_testing();
